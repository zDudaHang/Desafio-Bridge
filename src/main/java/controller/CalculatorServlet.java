...
/**
 * The servlet class for the calculator Purpose: Calculates the factorial of a
 * number, which is obtained through a request from cadastro.jsp, and returns
 * the result to the same .jsp
 * 
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if (parameter != "") {
			...
			if (result.compareTo(BigInteger.valueOf(-1)) == 0) {
				...
				request.setAttribute("result", Formatter.formatResult(result));
			}
		}
