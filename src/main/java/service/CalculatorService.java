...
/**
 * A service class to the web application Purpose: Calculates the factorial of a
 * given number and stores the calculations
 * 
...
public class CalculatorService {
	...
	/**
	 * Calculates the factorial and stores the calculation in history This method
	 * only stores the calculation if the results is bigger than -1
	 * 
	...
	/**
	 * Calculates the factorial of a number using the bottom-up algorithm (Dynamic
	 * Programming)
	 * 
	 * @param number The number to calculate the factorial
	 * @return If the number is equal or bigger than 0, returns the factorial of
	 *         number, else returns -1 indicating an invalid value for the parameter
	 */
